...
import org.aguaclara.post.collect.exception.JavaRosaException;
import org.aguaclara.post.collect.listeners.AdvanceToNextListener;
import org.aguaclara.post.collect.listeners.FormLoaderListener;
import org.aguaclara.post.collect.listeners.FormSavedListener;
import org.aguaclara.post.collect.listeners.SavePointListener;
import org.aguaclara.post.collect.logic.FormController;
import org.aguaclara.post.collect.logic.FormController.FailedConstraint;
import org.aguaclara.post.collect.preferences.AdminPreferencesActivity;
import org.aguaclara.post.collect.preferences.PreferencesActivity;
import org.aguaclara.post.collect.provider.FormsProviderAPI.FormsColumns;
...
import org.aguaclara.post.collect.tasks.FormLoaderTask;
import org.aguaclara.post.collect.tasks.SavePointTask;
import org.aguaclara.post.collect.tasks.SaveResult;
import org.aguaclara.post.collect.tasks.SaveToDiskTask;
import org.aguaclara.post.collect.utilities.CompatibilityUtils;
import org.aguaclara.post.collect.utilities.FileUtils;
import org.aguaclara.post.collect.utilities.MediaUtils;
import org.aguaclara.post.collect.views.ODKView;
import org.aguaclara.post.collect.widgets.QuestionWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener,
	...
	private void sendSavedBroadcast() {
		Intent i = new Intent();
		i.setAction("org.aguaclara.post.collect.FormSaved");
